#!/usr/bin/env bash
#Bash script that sets up a web server for deploymen#!/usr/bin/env bash
...
#--adds test string
echo "<h1>Welcome to www.robertokoba.tech</h1>" > /data/web_static/releases/test/index.html
...
echo -e "\e[1;32m restart NGINX\e[0m"t
